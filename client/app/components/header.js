    ...
    <header className="sticky top-0 z-50 bg-[#FF9933] text-white py-4 px-4 shadow-[0px_10px_10px_rgba(128,128,128,0.5)]  font-[Geneva, Verdana, Tahoma, system-ui, sans-serif] ">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Bug className="h-6 w-6 hover:fill-current" onClick={openModal} />
        ...
        {isModalOpen && (
          <div
            className="fixed inset-0 bg-transparent bg-opacity-10 flex justify-center items-center"
            onClick={handleOverlayClick}
          >
            <div className="bg-white p-6 rounded-lg shadow-lg w-1/3 max-w-md">
              <h2 className="text-lg font-bold mb-4">Help Information</h2>
              <p className="mb-4">
                This is a sample floating window. Click outside to close it.
              </p>
              <button
                onClick={closeModal}
                className="btn bg-amber-500 text-white px-4 py-2 rounded"
              >
                Close
              </button>
            </div>
