...
export default function Calendar2() {
              ...
              <thead>
                <tr>
                  ...
                  <th colSpan="3" className="th2">TutorIG:
                    <a className="th3" href={`https://instagram.com/${tutorIG || "defaultTutor"}`}>
                      {tutorIG || "N/A"}
                    </a>
                  </th>
                </tr>
  ...
  return (
    <section id="calendarSection">
      <div className="WeekTTBSectioncalendarHead" id="WeekTTBSectioncalendarHead">
        <h1>Weekly Class Schedule</h1><p>Click on the event to see the details</p>  {/* Legend on a new line */}
        <div className="WeekTTBcalendarlabelColor" id="WeekTTBcalendarlabelColor">
          <div className="label">
            <div className="WeekTTBorange-square" id="WeekTTBorange-square"></div>
            <p>Room X</p>
          </div>
          <div className="label">
